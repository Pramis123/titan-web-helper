    ...
    <div className="bg-white rounded-lg shadow-xl p-8">
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input placeholder="(323) 458-8728" {...field} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input placeholder="123 Main St, Los Angeles, CA" {...field} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
              ...
              <FormItem>
                ...
                <Select onValueChange={field.onChange} defaultValue={field.value}>
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="moving">Moving In/Out Cleaning</SelectItem>
                    <SelectItem value="construction">Post-Construction Cleaning</SelectItem>
                    <SelectItem value="office">Office & Organization</SelectItem>
          ...
          <Button 
            type="submit" 
            className="w-full bg-accent hover:bg-accent/90 text-white font-montserrat font-semibold text-base"
          >
            Book Now
          </Button>
          ...
          <div className="flex flex-col md:flex-row items-center justify-center space-y-4 md:space-y-0 md:space-x-4 pt-4">
            <Button
              variant="outline"
              className="flex items-center gap-2 bg-[#25D366] text-white hover:bg-[#25D366]/90 w-full md:w-auto"
              onClick={() => window.open("https://wa.me/13234588728", "_blank")}
            >
